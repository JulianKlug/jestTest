...
module.exports = function transformer(fileInfo, api, options) {
    ...
    const chaiExpectRemoved = (0, _imports.removeRequireAndImport)(j, root, 'chai', 'expect');
    const chaiShouldRemoved = (0, _imports.removeRequireAndImport)(j, root, 'chai', 'should');
    ...
    const typeOf = (value, args, containsNot) => {
        switch (args[0].value) {
            ...
            case 'error':
                return createCall('toBeInstanceOf', [j.identifier('Error')], updateExpect(value, node => node), containsNot);
            default:
    ...
    function withIn(p, rest, args, containsNot) {
        ...
        j(p).closest(j.ExpressionStatement).insertBefore(j.expressionStatement(createCall('toBeGreaterThanOrEqual', [args[0]], rest, containsNot)));
